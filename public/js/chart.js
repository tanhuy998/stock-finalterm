    ...
    success: function(data){
      ...
      depositebut.addEventListener("click",function(){
        if(parseFloat(inputmoney.value) > 0){
          ...
          $.ajax({        
              url: host + "/stock/home/deposite/",
              method: "get",
              data: sendObj, 
              //{sendObj: JSON.stringify(sendObj)},
              success: function(data){
                  console.log(data)
                  //console.log('deposite sussessfull');
                  if (data == 'deposite susess') {

                    money.innerHTML = (depositeAmount.toFixed(2)).toString()+'$';
                  }
